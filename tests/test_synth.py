...
class TestGenerateSyntheticTofRuns:
    ...
    def test_custom_parameters(self):
        ...
        runs, x, tof = generate_synthetic_tof_runs(
            n_runs=n_runs, n_detectors=n_detectors, n_bins=n_bins
        )
    ...
    def test_small_dataset(self):
        ...
        runs, x, tof = generate_synthetic_tof_runs(n_runs=10, n_detectors=4, n_bins=50)
    ...
    def test_metadata_consistency(self):
        ...
        n_det, n_bin = 15, 250
        runs, x, _ = generate_synthetic_tof_runs(n_runs=50, n_detectors=n_det, n_bins=n_bin)
